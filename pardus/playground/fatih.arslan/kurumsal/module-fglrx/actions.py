...
def install():
    ...
    pisitools.domove("/usr/lib/fglrx/fglrx-libGL.so.1.2", "/usr/lib/xorg/fglrx/lib", "libGL.so.1.2")
    pisitools.domove("/usr/lib/xorg/modules/extensions", "/usr/lib/xorg/fglrx")

    pisitools.domove("/usr/lib/xorg/fglrx/extensions/fglrx/fglrx-libglx.so", "/usr/lib/xorg/fglrx/extensions", "libglx.so")
