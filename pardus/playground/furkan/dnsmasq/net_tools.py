...
class Dev:
    ...
    def dns(self):
        ...
        elif self.namemode == "default":
            name_servers = call("dnsmasq", "Net.Stack", "getNameServers")

        call("dnsmasq", "Net.Stack", "useNameServers", (self.ifc.name, name_servers, name_domain))

    def resetDns(self):
        call("dnsmasq", "Net.Stack", "unuseNameServers", (self.ifc.name, [], ""))
