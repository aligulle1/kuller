...
def install():
    ...
    pisitools.dosym("/opt/sun-java5-jre/plugin/i386/ns7/libjavaplugin_oji.so", "/usr/lib/nsbrowser/plugins/javaplugin.so")

    for doc in ["COPYRIGHT", "LICENSE", "README.html", "THIRDPARTYLICENSEREADME.txt"]:
        file = "%s/opt/sun-java5-jdk/%s" % (get.installDIR(),doc)
