...
def setup():
    crosstools.configure("--enable-shared \
                          --disable-static \
                          --enable-maxmem=64")
...
def install():
    ...
    crosstools.rawInstall("prefix=%s/usr libdir=%s/usr/lib mandir=%s/usr/share/man/man1" % (get.installDIR(), get.installDIR(), get.installDIR()))
