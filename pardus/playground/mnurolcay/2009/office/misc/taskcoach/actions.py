...
WorkDir="TaskCoach-%s" % get.srcVERSION()

def build():
    #Remove shipped binary
    shelltools.unlinkDir("taskcoachlib/bin.in")
...
def install():
    ...
    pisitools.dodoc("CHANGES.txt", "LICENSE.txt", "PUBLICITY.txt", "README.txt")
