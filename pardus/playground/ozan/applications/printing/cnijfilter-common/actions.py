...
def install():
    ...
    pisitools.dodoc("usr/share/doc/cnijfilter-common-2.80/LICENSE-cnijfilter-2.80E.txt")
    pisitools.dodoc("usr/share/doc/cnijfilter-common-2.80/LICENSE-cnijfilter-2.80J.txt")
