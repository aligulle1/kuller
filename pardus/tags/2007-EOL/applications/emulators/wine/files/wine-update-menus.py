...
class Shortcut:
    def __init__(self, lnk_path, mode = "desktop"):
        ...
        self.icon_file = "_".join(dirs[2:-1] + [self.link_name + ".xpm"])

        if not os.path.exists(os.path.join(icon_dir, self.icon_file)):
        ...
        self.command = 'wine-start "%s"' % self.lnk_full_path
