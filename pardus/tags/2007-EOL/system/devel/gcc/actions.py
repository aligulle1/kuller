...
PREFIX = "/usr"
BINPATH = "/usr/%s/gcc-bin/3.4.6" % get.HOST()
LIBPATH = "/usr/lib/gcc/%s/3.4.6" % get.HOST()
INCDIR = "/usr/lib/gcc/%s/3.4.6/include" % get.HOST()
DATAPATH = "/usr/share/gcc-data/%s/3.4.6" % get.HOST()
MANPATH = "/usr/share/gcc-data/%s/3.4.6/man" % get.HOST()
INFOPATH = "/usr/share/gcc-data/%s/3.4.6/info" % get.HOST()
STDCXX_INCDIR = "/usr/lib/gcc/%s/3.4.6/include/g++-v3" % get.HOST()
...
def install():
    ...
    # Fix libstdc++ path
    pisitools.dosed("%s/usr/lib/gcc/i686-pc-linux-gnu/3.4.6/libstdc++.la" % get.installDIR(), 
                    "libdir=libstdc\\+\\+.la", "libdir='/usr/lib/gcc/i686-pc-linux-gnu/3.4.6'")
