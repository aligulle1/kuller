...
def install():
    ...
    # Don't use autotools.install() else it won't work
    ...
    # Cleanup LDFLAGS
    pisitools.dosed("%s/usr/bin/krb5-config" % get.installDIR(),"LDFLAGS=\'-Wl,-Bdirect -Wl,-hashvals -Wl,-zdynsort\'","LDFLAGS=\"\"")
