...
$output_width = 250;    	# wrap at 80 columns by default (/width:nn option)
...
$advise_re_policy_opts = 0;	# remind folks they can use /hdr:L and /cand:L to see more message details
