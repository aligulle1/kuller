...
def install():
    ...
    pisitools.insinto("/usr/share/icons/Tulliana-2.0", "author")
    pisitools.insinto("/usr/share/icons/Tulliana-2.0", "index.theme")
    pisitools.insinto("/usr/share/icons/Tulliana-2.0", "license.txt")
    pisitools.insinto("/usr/share/icons/Tulliana-2.0", "readme.txt")
    pisitools.insinto("/usr/share/icons/Tulliana-2.0", "thanks.to")
