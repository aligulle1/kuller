...
def postInstall(fromVersion, fromRelease, toVersion, toRelease):
    ...
    groups = ["squid", "named", "mysql", "postgres", "apache", "dovecot", "users", "hal", "postfix", \
              "postdrop", "smmsp", "slocate", "utmp", "firebird", "dhcp", "ldap", "clamav", "ntlmaps", \
              ...
              "vboxusers", "svn", "pnp", "removable", "netuser", "netadmin", "power", "pnpadmin", "kvm", \
              "memcached"]
    ...
    users = ["dialout", "squid", "named", "mysql", "postgres", "apache", "dovecot", "hal", "postfix", "smmsp", \
             ...
             "svn", "icecast", "pnp", "spamd", "memcached"]
    ...
    hav("addGroup", (145, "vboxusers"))
    hav("addGroup", (146, "kvm"))
