...
def postInstall(fromVersion, fromRelease, toVersion, toRelease):
    ...
    groups = ["lp", "floppy", "uucp", "cdrom", "squid", "gdm", "xfs", "games", \
                ...
                "dhcp", "ntlmaps", "ldap", "clamav", "dovecot", "hal", "avahi", "ntp", "tss", "ejabberd", \
                "tomcat", "ups", "pnp", "removable", "netuser", "netadmin", "power", "pnpadmin", "partimag", \
                "radiusd"]
    ...
    users = ["lp", "uucp", "squid", "gdm", "xfs", "games", \
                ...
                "dhcp", "ntlmaps", "ldap", "clamav", "dialout", "dovecot", "hal", \
                "avahi", "ntp", "tss", "ejabberd", "tomcat", "ups", "pnp", "partimag", \
                "radiusd"]
    ...
    hav("addUser", (80, "apache", "Apache", "/dev/null", "/bin/false", "", ["apache"], [], []))
    ...
    hav("addUser", (131, "ejabberd", "Ejabberd", "/dev/null", "/bin/false", "", ["ejabberd"], [], []))
