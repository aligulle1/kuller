...
def install():
    ...
    # this music keeps making strange noises after second loop
    pisitools.remove("/usr/share/amoebax/music/AngusBackground.ogg")
    pisitools.dosym("/usr/share/amoebax/music/Mr.BonesBackground.ogg", "/usr/share/amoebax/music/AngusBackground.ogg")
