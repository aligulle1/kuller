...
def install():
    ...
    # Move master.cf and postfix-script and post-install scripts
    pisitools.domove("/usr/share/doc/%s/defaults/master.cf" % get.srcTAG(), "/etc/postfix/")
    ...
    pisitools.dodoc("*README", "COMPATIBILITY", "HISTORY", "LICENSE", "RELEASE_NOTES")
