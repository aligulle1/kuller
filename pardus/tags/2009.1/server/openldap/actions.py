...
def setup():
    ...
    # shelltools.export("CFLAGS","%s  -D_REENTRANT -D_GNU_SOURCE -fPIC -I/usr/include/db-4.5 -ldb-4.5" % get.CFLAGS())
    # shelltools.export("CPPFLAGS","%s -D_REENTRANT -D_GNU_SOURCE -fPIC -I/usr/include/db-4.5 -ldb-4.5" % get.CFLAGS())
