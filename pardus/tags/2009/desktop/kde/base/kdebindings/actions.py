...
def setup():
    ...
    cmaketools.configure("-DBUILD_csharp=OFF -DENABLE_KROSSFALCON=ON -DENABLE_PHP-QT=ON -DENABLE_SMOKE=ON -DRUBY_SITE_LIB_DIR=/usr/lib/ruby/site_ruby/1.8 -DRUBY_SITE_ARCH_DIR=/usr/lib/ruby/site_ruby/1.8/i686-linux -DENABLE_SMOKE=ON", installPrefix="/usr/kde/4", sourceDir="..")
