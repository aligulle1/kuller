...
def install():
    ...
    # FIXME: Why not to continue with upstream decisions in 2009?
    ...
    shelltools.echo("%s/etc/udev/rules.d/README" % get.installDIR(),
                    "This directory is replaced by /lib/udev/rules.d and is only kept for backward compatibility.")

    # Install docs
    pisitools.dodoc("COPYING", "ChangeLog", "README", "TODO")
    pisitools.dohtml("docs/writing_udev_rules/")
